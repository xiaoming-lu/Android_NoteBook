...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        else if (id == R.id.action_add_note)
        {
            ...
            intent.putExtra(MainActivityListFragment.NOTE_Fragment_To_Load_EXTRA,FragmentToLaunch.CREATE);
            startActivity(intent);
            return true;
        }
    ...
    private void loadPreference()
    {
        ...
        String noteTitle=sharedPreferences.getString("title","NoteBook");
        setTitle(noteTitle);
    }
}
